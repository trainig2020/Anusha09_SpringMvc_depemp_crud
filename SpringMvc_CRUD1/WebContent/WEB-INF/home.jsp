...
<body>
	...
	<div id="header">
		<h2>
			<a href="/SpringMvc_CRUD1?siteLanguage=en">English</a>|<a
				href="/SpringMvc_CRUD?siteLanguage=jp">Japenese</a>
		</h2>
	</div>
		...
		<c:if test="${name eq 'names'}">
			<c:forEach var="dept" items="${DeptListemp}">
				<c:if test="${not empty dept}">
					...
					<br>
				             &nbsp <a href="home"><b>=></b></a>&nbsp <button
	...
	<div id=main>
		...
		<c:if test="${homepage eq 'emppage'}">
			...
			<table border="2" style="width: 100%"background-color:#eee;>
				<thead>
					<tr>
						<th colspan="3" style="text-align: center"><h1>Employee
								Details</h1></th>
						<th colspan="2" style="text-align: center"><a
